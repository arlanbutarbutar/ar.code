<?php if(!isset($_SESSION)){session_start();}
    ...
    $_SESSION['page-name']="Laporan DP/Uang Muka";
?>

<!-- == Laporan DP/Uang Muka page == -->
<!DOCTYPE html>
<html lang="id">
    <head>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php $id_tek=$row_all['id_pegawai'];
                                                            $teknisi=mysqli_query($conn, "SELECT * FROM users WHERE id_user='$id_tek'");foreach($teknisi as $row_tek){echo $row_tek['first_name'];}?>
                                                        </td>
