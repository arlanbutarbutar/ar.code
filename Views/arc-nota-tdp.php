...
<html lang="en">
    <head>
        ...
        <title>♻ Nota DP | <?= $_SESSION['name-web']?></title>
    </head>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid" style="margin-top: 100px">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h2 mb-0 text-gray-800">♻ Nota DP</h1>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card border-0 shadow">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div class="col-lg-4">
                                                <form action="" method="POST">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control bg-light border-0 small" placeholder="Search" aria-label="Search" aria-describedby="basic-addon2" autofocus name="keyword-arc-nota-dp">
                                                        <div class="input-group-append">
                                                            <button class="btn" <?= $style_btn?> type="submit" name="search-arc-nota-dp">
                                            ...
                                            <nav class="small" aria-label="Page navigation example">
                                                <ul class="pagination justify-content-end">
                                                    <?php if(isset($page21)){if(isset($total_page21)){if($page21>1):?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="arc-nota-tdp?page=<?= $page21-1;?>" tabindex="-1" aria-disabled="true">Previous</a>
                                                    </li>
                                                    <?php endif;?>
                                                    <?php for($i=1; $i<=$total_page21; $i++):?>
                                                        <?php if($i<=5):?>
                                                            <?php if($i==$page21):?>
                                                                <li class="page-item"><a class="page-link font-weight-bold" href="arc-nota-tdp?page=<?= $i;?>"><?= $i;?></a></li>
                                                            <?php else :?>
                                                                <li class="page-item"><a class="page-link" href="arc-nota-tdp?page=<?= $i;?>"><?= $i;?></a></li>
                                                            <?php endif;?>
                                                        <?php endif;?>
                                                    <?php endfor;?>
                                                    <?php if($page21<$total_page21):?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="arc-nota-tdp?page=<?= $page21+1;?>">Next</a>
                                                    </li>
                                                    <?php endif;}}?>
                                                </ul>
                                            </nav>
                                        ...
                                        <table class="table table-hover text-dark table-responsive table-sm">
                                            ...
                                            <tbody>
                                                <?php $no=1; foreach($mdata_nota_dp as $row):?>
                                                <tr>
                                                    <th scope="row"><?= $no?></th>
