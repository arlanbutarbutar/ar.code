...
<html lang="en">
    <head>
        ...
        <title>Setting Nota | <?= $_SESSION['name-web']?></title>
        <script type="text/javascript">
            var otomatis = setInterval(function (){
                $('#timestamp').load('../controller/ajax_timestamp.php').fadeIn("slow");
            }, 1000);
        </script>
    </head>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid" style="margin-top: 100px">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h2 mb-0 text-gray-800">Setting Nota</h1>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-lg-4 mt-3">
                                <div class="card shadow border-0 mb-3">
                                    <div class="card-body text-center text-dark">
                                        <h3 id="timestamp"><?php require_once("../controller/ajax_timestamp.php")?></h3>
