                ...
                <div id="content">
                    ...
                    <div class="container-fluid" style="margin-top: 100px">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h2 mb-0 text-gray-800">Nota Cancel</h1>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="collapse show mt-3" id="collapseOffline">
                                    <div class="card card-body shadow border-0">
                                        
                                        <div class="col-md-12p-3 d-sm-flex align-items-center justify-content-start" id="scroll-x">

                                            <div class="col-md-3">
                                                <form action="" method="POST">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control bg-light border-0 small" placeholder="Search No Nota Cancel" aria-label="Search" aria-describedby="basic-addon2" autofocus id="keyword-nota-cancel">
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <form action="" method="POST">
                                                    <div class="input-group">
                                                        <input type="date" class="form-control bg-light border-0 small" placeholder="Search Date" aria-label="Search" aria-describedby="basic-addon2" autofocus name="keyword-tgl-nota-cancel">
                                                        <div class="input-group-append">
                                                            <button class="btn" <?= $style_btn?> type="submit" name="search-tgl-nota-cancel">
                                            ...
                                            <div class="col-lg-3">
                                                <form action="" method="POST">
                                                    <div class="input-group">
                                                        <select name="keyword-teknisi-nota-cancel" class="form-control">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button class="btn" <?= $style_btn?> type="submit" name="search-teknisi-nota-cancel">
                                                                <i class="fas fa-search fa-sm"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="d-flex justify-content-between mt-3">
                                            <h6 class="text-dark font-weight-bold">Nota Cancel</h6>
                                            <nav class="small" aria-label="Page navigation example">
                                                <ul class="pagination justify-content-end">
                                                    <?php if(isset($page3)){if(isset($total_page3)){if($page3>1):?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="nota-cancel?page=<?= $page3-1;?>" tabindex="-1" aria-disabled="true">Previous</a>
                                                    </li>
                                                    <?php endif;?>
                                                    <?php for($i=1; $i<=$total_page3; $i++):?>
                                                        <?php if($i<=5):?>
                                                            <?php if($i==$page3):?>
                                                                <li class="page-item"><a class="page-link font-weight-bold" href="nota-cancel?page=<?= $i;?>"><?= $i;?></a></li>
                                                            <?php else :?>
                                                                <li class="page-item"><a class="page-link" href="nota-cancel?page=<?= $i;?>"><?= $i;?></a></li>
                                                            <?php endif;?>
                                                        <?php endif;?>
                                                    <?php endfor;?>
                                                    <?php if($page3<$total_page3):?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="nota-cancel?page=<?= $page3+1;?>">Next</a>
                                                    </li>
                                                    <?php endif;}}?>
                                                </ul>
                                            </nav>
                                        ...
                                        <div class="table-responsive" id="container-nota-cancel">
                                            <table class="table table-sm text-dark text-center">
                                                ...
                                                <tbody>
                                                    <?php $no=1;if(mysqli_num_rows($nota_cancel)==0){?>
                                                    <tr>
                                                        <th colspan="19">Maaf data saat ini kosong!</th>
                                                    </tr>
                                                    <?php }else if(mysqli_num_rows($nota_cancel)>0){while($row=mysqli_fetch_assoc($nota_cancel)){?>
                                                    <tr>
                                                        <th scope="row"><?= $no;?></th>
                                                        ...
                                                        <td><form action="" method="POST">
                                                            ...
                                                            <button type="submit" name="delete-nota-cancel" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
                                                        </form></td>
