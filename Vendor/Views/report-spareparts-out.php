...
<html lang="en">
    <head>
        ...
        <title>Spareparts Out | <?= $_SESSION['name-web']?></title>
    </head>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid" style="margin-top: 100px">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h2 mb-0 text-gray-800">Spareparts Sudah Diambil</h1>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive" id="container-sparepart">
                                            <table class="table table-borderless text-dark text-center table-responsive">
                                                ...
                                                <tbody>
                                                    <?php $no=1;if(mysqli_num_rows($out_spareparts)==0){?>
                                                    <tr>
                                                        <th colspan="19">Maaf data saat ini kosong!</th>
                                                    </tr>
                                                    <?php }else if(mysqli_num_rows($out_spareparts)>0){while($row=mysqli_fetch_assoc($out_spareparts)){?>
                                                    <tr>
                                                        <th scope="row"><?= $no;?></th>
                                                        <td><?= $row['tgl_masuk']?></td>
                                                        <?php if($_SESSION['id-role']==5){?>
