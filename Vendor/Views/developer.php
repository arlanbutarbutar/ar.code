...
<html lang="en">
    <head>
        ...
        <title>Developer | <?= $_SESSION['name-web']?></title>
    </head>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid" style="margin-top: 100px">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h2 mb-0 text-gray-800">Developer</h1>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <div class="col-md-12 shadow rounded" id="scroll-x">
                                    <table class="table table-borderless table-sm text-center text-dark mt-3">
                                        ...
                                        <tbody>
                                            <?php $no=1;if(mysqli_num_rows($developer_data)==0){?>
                                            <tr><td colspan="19" class="text-dark font-weight-bold">Maaf data saat ini kosong!</td></tr>
                                            <?php }else if(mysqli_num_rows($developer_data)>0){while($row=mysqli_fetch_assoc($developer_data)){?>
                                            <tr>
                                                <th scope="row"><?= $no;?></th>
                                                <form action="" method="POST">
                                                    <td>
