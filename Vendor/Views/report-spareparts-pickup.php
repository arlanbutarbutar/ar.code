...
<html lang="en">
    <head>
        ...
        <title>Spareparts Pickup | <?= $_SESSION['name-web']?></title>
    </head>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid" style="margin-top: 100px">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h2 mb-0 text-gray-800">Spareparts Sudah Dipakai</h1>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12 p-3 d-sm-flex align-items-center justify-content-start" id="scroll-x">
                                            ...
                                            <div class="col-lg-3">
                                                <form action="" method="POST">
                                                    <div class="input-group">
                                                        <input type="date" class="form-control bg-light border-0 small" placeholder="Search Date" aria-label="Search" aria-describedby="basic-addon2" name="keyword-tgl-sparepart-pickup">
                                                        <div class="input-group-append">
                                                            <button class="btn" <?= $style_btn?> type="submit" name="search-tgl-sparepart-pickup">
                                            ...
                                            <div class="col-lg-3">
                                                <form action="" method="POST">
                                                    <div class="input-group">
                                                        <select name="keyword-teknisi-sparepart-pickup" class="form-control">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button class="btn" <?= $style_btn?> type="submit" name="search-teknisi-sparepart-pickup">
                                                                <i class="fas fa-search fa-sm"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <h6 class="text-dark font-weight-bold">Laporan Spareparts</h6>
                                            <nav class="small" aria-label="Page navigation example">
                                                <ul class="pagination justify-content-end">
                                                    <?php if(isset($page15)){if(isset($total_page15)){if($page15>1):?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="report-spareparts-pickup?page=<?= $page15-1;?>" tabindex="-1" aria-disabled="true">Previous</a>
                                                    </li>
                                                    <?php endif;?>
                                                    <?php for($i=1; $i<=$total_page15; $i++):?>
                                                        <?php if($i<=5):?>
                                                            <?php if($i==$page15):?>
                                                                <li class="page-item"><a class="page-link font-weight-bold" href="report-spareparts-pickup?page=<?= $i;?>"><?= $i;?></a></li>
                                                            <?php else :?>
                                                                <li class="page-item"><a class="page-link" href="report-spareparts-pickup?page=<?= $i;?>"><?= $i;?></a></li>
                                                            <?php endif;?>
                                                        <?php endif;?>
                                                    <?php endfor;?>
                                                    <?php if($page15<$total_page15):?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="report-spareparts-pickup?page=<?= $page15+1;?>">Next</a>
                                                    </li>
                                                    <?php endif;}}?>
                                                </ul>
                                            </nav>
                                        ...
                                        <div class="table-responsive" id="container-sparepart">
                                            <table class="table table-borderless text-dark text-center table-responsive">
                                                ...
                                                <tbody>
                                                    <?php $no=1;if(mysqli_num_rows($pickup_spareparts)==0){?>
                                                    <tr>
                                                        <th colspan="19">Maaf data saat ini kosong!</th>
                                                    </tr>
                                                    <?php }else if(mysqli_num_rows($pickup_spareparts)>0){while($row=mysqli_fetch_assoc($pickup_spareparts)){?>
                                                    <tr>
                                                        <th scope="row"><?= $no;?></th>
                                                        <td><?= $row['tgl_masuk']?></td>
                                                        <?php if($_SESSION['id-role']==5){?>
